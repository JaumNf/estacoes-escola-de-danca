...
export default function CursosIntensivos() {
  ...
  const shareWhatsAppPage = () => {
    const msg = encodeURIComponent("Dançar não é um bicho de sete cabeças! Descubra como é fácil dar o primeiro passo. Vem comigo para o intensivo de dança da Estações! " + window.location.href);
      ...
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center bg-[#120400] text-orange-50 overflow-hidden">
        ...
        <div className="max-w-4xl w-full mx-auto text-center relative z-10 px-6 py-24 flex flex-col items-center justify-center h-full">
          ...
          <div className="mt-12 w-full max-w-md flex flex-col items-center">
            <span className="text-[#d88961] font-bold text-sm tracking-widest uppercase mb-4">CHAME A GALERA PARA DANÇAR:</span>
            <div className="flex w-full gap-3">
              <button onClick={shareWhatsAppPage} className="flex-1 bg-[#25D366] hover:bg-[#1ebd5c] text-white py-4 rounded-xl flex items-center justify-center gap-2 font-bold shadow-lg transition-colors">
              ...
              <button 
                onClick={() => { navigator.clipboard.writeText('https://www.escoladancaestacoes.com.br/cursos-intensivos'); alert('Link copiado!'); }} 
                className="bg-white/10 hover:bg-white/20 text-white w-14 rounded-xl flex items-center justify-center transition-colors"
